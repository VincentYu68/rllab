...
if __name__ == '__main__':
    ...
    test_epochs = 300
    seed=1
    append = 'hopper_bidirectionstop_6432net_sd%d_splitstd_maskedgrad_specbaseline_%dk_%d_%d_unweighted'%(seed,batch_size/1000, initialize_epochs, grad_epochs)
    ...
    split_percentages = [0.0, 0.4, 0.8, 1.0]
