...
from rllab.core.network import MLP, HMLP, HMLP_NonConcat, HMLPPhaseHumanoid
...
class GaussianHMLPPhaseHumanoidPolicy(GaussianMLPPolicy):
    def __init__(
            self,
            env_spec,
            hidden_sizes=(),
        ...
        if mean_network is None:
            mean_network = HMLPPhaseHumanoid(
                hidden_sizes,
                hidden_nonlinearity,
                input_shape=(obs_dim,),
                hlc_output_dim = hlc_output_dim,
                sub_out_dim1=sub_out_dim1,
                sub_out_dim2=sub_out_dim2,
